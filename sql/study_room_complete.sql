-- 自习室座位预约系统：从零建库，在 MySQL 中执行本文件一次即可（MySQL 8.x）
...
INSERT INTO `sys_config` VALUES (19, '违规达阈值自动拉黑', 'violation.auto.blacklist.enabled', 'false', 'Y', 'admin', NOW(), '', NULL, 'true=开启；达到 violation.count.threshold 次则写入黑名单');
INSERT INTO `sys_config` VALUES (20, '违规累计次数阈值', 'violation.count.threshold', '3', 'Y', 'admin', NOW(), '', NULL, '统计 violation.lookback.days 天内');
INSERT INTO `sys_config` VALUES (21, '违规统计回溯天数', 'violation.lookback.days', '90', 'Y', 'admin', NOW(), '', NULL, NULL);
INSERT INTO `sys_config` VALUES (22, '勋章兑换豁免黑名单', 'medal.redeem.bypassBlacklist', 'true', 'Y', 'admin', NOW(), '', NULL, 'true=已兑换勋章用户可豁免预约黑名单');
INSERT INTO `sys_config` VALUES (23, '校园短信注册默认角色', 'campus.register.roleId', '3', 'Y', 'admin', NOW(), '', NULL, '对应 sys_role 中学生角色 role_id=3');
